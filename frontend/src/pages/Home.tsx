      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center">
            <h1 className="font-display text-xl sm:text-2xl md:text-3xl leading-relaxed tracking-tight mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/search"
                className="inline-flex items-center justify-center px-6 py-3 border-2 border-ink shadow-pixel-sm font-display text-[10px] sm:text-xs tracking-wide bg-white text-primary-600 hover:bg-gray-100 active:shadow-none active:translate-x-1 active:translate-y-1 transition-colors"
              >
